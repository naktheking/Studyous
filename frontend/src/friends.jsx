...
function FriendRequest({ loggedInUser, isOpen, setIsOpen })
{
    ...
    const handleRejectRequest = async (fromUsername) => {
        ...
        return(
                <div className="friend-panel">  {/*the className was made by AI */ }
                    <button
                    ...
                    {isOpen && (
                        <div className="friend_req_bar">           {/*the className was made by AI */ }
                            <input
                                    type="text"
                            ...
                            <button
                                    ...
                                    disabled={!username}
                                    style={{
                                            backgroundColor: username ? '#007bff' : 'var(--surface)',        /* the font color was generated by AI */
                            ...
                            {requestMessage && (
                                <p style={{ fontSize: '13px', marginTop: '6px', color: requestMessage.includes('sent to') ? '#28a745' : '#dc3545' }}>      {/*the font color was made by AI */ }
                                    {requestMessage}
                                </p>
                            )}
                            ...
                            <div style={{ marginTop: '20px' }}>
                                ...
                                {incomingRequests.length > 0 ? (
                                    <div>
                                        <div className="incoming-request-item">                     {/*these classNames were generated by AI */}
                            ...
                            <div className="friend-list-panel">       {/*the className was made by AI */ }
